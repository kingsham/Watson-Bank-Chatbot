...
const assistant = new AssistantV1(
  {
  version: '2019-02-28',
  iam_apikey:'_pO2TTMqOJp66R97wFZAQShDDptnfRZ8bCAVm3QngLMs',
  url:'https://gateway.watsonplatform.net/assistant/api'
  }
);

assistant.message({
  workspace_id: 'a177772f-cfef-400f-a91c-6bec09e113a4',
    input: { text: 'Hello' }
  })
  .then(res => {
...
const discovery = new DiscoveryV1({
  version:'2018-03-05' ,
  iam_apikey:'Bm2c2iS6BLUnWCHL_Dp9VRznBvaCTjKttGt4zZH8sR9d',
...
const nlu = new NaturalLanguageUnderstandingV1(
  {
    version: '2019-04-02',
    iam_apikey:'df7RC0t45aEh-MASfG0E9Pd0bK30ESJy-HggvphdSTnx',
...
const toneAnalyzer = new ToneAnalyzerV3(
  {
    version: '2017-09-21',
    iam_apikey:'nVBviial6JuBF6KTBPToCVdVulDzgdcvxgumvOdEWEhB',
